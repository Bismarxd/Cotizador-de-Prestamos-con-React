...
const [pago, setPago]= useState(calcularTotalPagar(cantidad, meses));


//use effect para calcular el total a pagar
useEffect(() => {
...
//use effect para calcular el total a pagar por mes
useEffect(() => {
